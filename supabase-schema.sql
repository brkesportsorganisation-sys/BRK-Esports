...
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "name" TEXT NOT NULL DEFAULT 'Player';
...
CREATE INDEX IF NOT EXISTS "idx_user_freefireuid" ON "User"("freeFireUid");
...
VALUES 
    ...
    ('admin_owner_ayan', 'ayan', 'ayan@blackrock.gg', '$2b$10$e2C6XdBNHzp89rtV1snA8u25d7eBHDyM7a5INEFULq6ierbDLdp6.', 'Ayan (Owner)', 'OWNER', ARRAY['view_dashboard','manage_tournaments','enter_results','manage_users','manage_bans','moderate_lfg','manage_deposits','manage_withdrawals','adjust_wallets','view_financial_reports','manage_referrals','manage_watch_earn','manage_roles','approve_deletes','send_notifications','manage_settings'], true, 'Owner')
