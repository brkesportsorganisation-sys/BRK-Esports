...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const updates: Record<string, any> = {
      ...
      ...(body.tournamentBatchFormat !== undefined ? { tournamentBatchFormat: body.tournamentBatchFormat } : {}),
      ...(body.roomCapacity !== undefined ? { roomCapacity: Number(body.roomCapacity) } : {}),
      ...(body.maxRooms !== undefined ? { maxRooms: body.maxRooms !== null && body.maxRooms !== '' ? Number(body.maxRooms) : null } : {}),
      ...(body.defaultAdvancementCount !== undefined ? { defaultAdvancementCount: Number(body.defaultAdvancementCount) } : {}),
